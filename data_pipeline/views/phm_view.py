...
class PHMView(BaseView):
    ...
    def parse(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        namespace = f"{request.get('module', 'PHM')}_primary"
        def compute():
        ...
        namespace_sec = f"{request.get('module', 'PHM')}_secondary"
        def compute_sec():
